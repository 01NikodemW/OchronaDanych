...
export default function MainPage() {
    ...
    const [registerPasswordValue, setRegisterPasswordValue] = useState<string>("")
    const [registerRepeatPasswordValue, setRegisterRepeatPasswordValue] = useState<string>("")
    const [passwordStrength, setPasswordStrength] = useState<PasswordStrength>(PasswordStrength.Strong)
    ...
    const changePasswordStrength = () => {
        ...
        for (let i = 0; i < 256; i++) {
            if (array[i] > 0) {
                passwordEntropy = passwordEntropy - (array[i] / passwordLength) * Math.log2(array[i] / passwordLength)
            }
        }
        setPasswordStrength(passwordEntropy < 2 ?
            PasswordStrength.Weak : passwordEntropy < 3 ?
                PasswordStrength.Medium : PasswordStrength.Strong)

        if (mostCommonPasswords.includes(registerPasswordValue) || passwordLength < 7) {
            console.log("lipa")
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    {showLoginPage && <Box
                        ...
                        <Button sx={{ color: "#E9E9EB", width: "220px", marginTop: "130px" }} onClick={onGoToRegisterClickHandler}>
                    ...
                    {!showLoginPage && <Box
                        ...
                        <TextField
                            ...
                            onChange={(e) => { setRegisterRepeatPasswordValue(e.target.value) }}
                            sx={{
                                marginTop: "20px",
                                marginBottom: "20px",
                                input: {
                        ...
                        />
                        {passwordStrength === PasswordStrength.Weak && < Box
                            sx={{
                                display: "flex",
                        ...
                        >
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "red", border: "1px solid black" }} />
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "#43506C", border: "1px solid black" }} />
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "#43506C", border: "1px solid black" }} />

                        </Box>}
                        {passwordStrength === PasswordStrength.Medium && < Box
                            sx={{
                                display: "flex",
                                justifyContent: "center",
                                width: "100%",
                        ...
                        >
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "yellow", border: "1px solid black" }} />
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "yellow", border: "1px solid black" }} />
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "#43506C", border: "1px solid black" }} />

                        </Box>}
                        {passwordStrength === PasswordStrength.Strong && < Box
                            sx={{
                                display: "flex",
                                justifyContent: "center",
                                width: "100%",
                        ...
                        >
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "green", border: "1px solid black" }} />
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "green", border: "1px solid black" }} />
                            <Box sx={{ width: "50px", height: "5px", bgcolor: "green", border: "1px solid black" }} />

                        </Box>}
                        <Button
                            disabled={registerEmailValue.length == 0 || registerPasswordValue.length == 0 || registerRepeatPasswordValue.length == 0}
                            sx={{
                                bgcolor: "#E9E9EB",
                                color: "#3D619B",
                                border: "3px solid #E9E9EB",
                        ...
                        <Button sx={{ color: "#E9E9EB", width: "220px", marginTop: "80px" }} onClick={onGoToLoginClickHandler}>
                            Wróć do logowania
                        </Button>
                    </Box>}
                </Box>
